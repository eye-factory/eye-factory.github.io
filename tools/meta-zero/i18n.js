(() => {
  ...
  const en = {
    skip: 'Skip to tool', language: 'Language', eyebrow: 'LOCAL PRIVACY TOOL',
    ...
    dropTitle: 'Drop images or MP4 here', dropSub: 'or click to select', limits: 'JPEG / PNG / WebP up to 10 · MP4 up to 3',
    selectedFiles: 'Selected files', clear: 'Clear all', processing: 'Processing', processButton: 'Remove data and save', cancel: 'Cancel',
    outputNote: 'Output: meta_zero.ext / meta_zero_01.ext …',
  ...
  const ja = {
    skip: 'ツールへ移動', language: '言語', eyebrow: 'LOCAL PRIVACY TOOL', lead: '写真と動画はそのまま。残したくない情報だけをゼロへ。',
    ...
    dropTitle: '画像・MP4をここへドロップ', dropSub: 'またはクリックして選択', limits: 'JPEG / PNG / WebP 最大10枚・MP4 最大3本', selectedFiles: '選択したファイル', clear: 'すべて解除', processing: '処理中', processButton: '情報を除去して保存', cancel: '中止', outputNote: '出力名：meta_zero.ext / meta_zero_01.ext …',
